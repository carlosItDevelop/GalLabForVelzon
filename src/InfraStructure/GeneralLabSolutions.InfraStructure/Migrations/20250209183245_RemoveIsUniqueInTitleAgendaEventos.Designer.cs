...
namespace GeneralLabSolutions.InfraStructure.Migrations
{
    ...
    [Migration("20250209183245_RemoveIsUniqueInTitleAgendaEventos")]
    partial class RemoveIsUniqueInTitleAgendaEventos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GeneralLabSolutions.Domain.Entities.Agendamento", b =>
                {
                    ...
                    b.HasIndex("Descricao")
                        .HasDatabaseName("IX_Agendamento_Descricao");

                    b.HasIndex("Localizacao")
                        .HasDatabaseName("IX_Agendamento_Localizacao");

                    b.HasIndex("Titulo")
                        .IsUnique()
                        .HasDatabaseName("IX_Agendamento_Titulo");
